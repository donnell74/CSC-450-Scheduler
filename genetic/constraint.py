...
def all_before_time(this_week, args):
    ...
    for course_obj in list_of_course_objs:  # access list of courses
        holds.append(course_before_time(this_week, [course_obj, time_obj, is_mandatory]))
...
def all_after_time(this_week, args):
    ...
    for course_obj in list_of_course_objs:  # access list of courses
        holds.append(course_after_time(this_week, [course_obj, time_obj, is_mandatory]))
...
def instructor_time_pref_before(this_week, args):
    ...
    for course in instructor_obj.courses:
        ...
        if each_section.time_slots[0].start_time >= time_obj:
            #case 1: a course fails
            holds.append(0)
        else:
            # case 2: a course passes
            holds.append(1)
